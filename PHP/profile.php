...
<nav class="navbar navbar-expand-lg navbar-light">
  <div class="container-fluid">
    <h1 class = "navbar h1"><a class="navbar-brand" href="#">Profile</a></h1>
...
<div class="form">
  <form method="post" action = "/updatePass.php">
    <div class="form-group" >
      ...
      <input type="password" class="form-control" id="exampleInputPassword" name = "oldPassword" placeholder="Enter Old Password" required>
    </div>
    <div class="form-group">
